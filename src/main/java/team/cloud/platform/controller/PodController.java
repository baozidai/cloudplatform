...
public class PodController {
    ...
    public Result listPodByUserIdAndType(@PathVariable("userId") Integer userId, @RequestParam("podType") Integer type){
    ...
    public ModelAndView containerList() {
        ModelAndView mv = new ModelAndView();
